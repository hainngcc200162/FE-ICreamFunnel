...
async function searchStores(pageNumber = 1, pageSize = 10) {
    ...
    try {
        ...
        if (stores.length === 0) {
            ...
            updatePagination(1, 1); // vẫn gọi để reset phân trang
            return;
        }
...
function updatePagination(currentPage, totalPages) {
    const paginationContainer = document.querySelector('#searchStoreModal .pagination');

    // Cập nhật các nút "Đầu tiên" và "Trước"
